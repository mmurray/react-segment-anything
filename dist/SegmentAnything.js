...
var SegmentAnything = function (_a) {
    var image = _a.image, embedding = _a.embedding, modelUrl = _a.modelUrl, handleMaskSaved = _a.handleMaskSaved;
    // ONNX model
    var _b = useState(null), model = _b[0], setModel = _b[1];
    // Tool mode
    var _c = useState(ToolMode.Default), mode = _c[0], setMode = _c[1]; // Tool mode
    // Model parameters (clicks and bounding box)
    var _d = useState([]), clicks = _d[0], setClicks = _d[1];
    var _e = useState(undefined), bbox = _e[0], setBbox = _e[1];
    // Mask image
    var _f = useState(undefined), maskImage = _f[0], setMaskImage = _f[1];
            ...
            React.createElement(Grid, { container: true, spacing: 2 },
                React.createElement(Grid, { item: true, xs: 3 },
                    React.createElement(Stack, { spacing: 2, className: "react-sam-toolbar" },
                        ...
                        React.createElement(Button, { disabled: !maskImage, onClick: function () { return handleMaskSaved(maskImage, image); }, sx: { mt: 2 }, className: 'react-sam-toolbar-save', startIcon: React.createElement(CheckIcon, null), size: "large", color: "success", variant: "contained" }, "Save Mask"))),
...
//# sourceMappingURL=SegmentAnything.js.map